...
export function normalizeHomepageSettings(raw) {
  ...
  return {
    ...
    searchCta: {
      ...
      primary_button_text: pickText(
        searchRaw.primary_button_text,
        searchRaw.primaryButton?.text,
        searchRaw.button_text,
        searchRaw.primary_button?.text,
        searchRaw.button?.text,
      ),
      primary_button_url: pickText(
        searchRaw.primary_button_url,
        searchRaw.primaryButton?.url,
        searchRaw.button_url,
        searchRaw.primary_button?.url,
        searchRaw.button?.url,
      ),
      secondary_button_text: pickText(
        searchRaw.secondary_button_text,
        searchRaw.secondaryButton?.text,
        searchRaw.fallback_text,
        searchRaw.secondary_button?.text,
        searchRaw.fallback_button?.text,
      ),
      secondary_button_url: pickText(
        searchRaw.secondary_button_url,
        searchRaw.secondaryButton?.url,
        searchRaw.fallback_url,
        searchRaw.secondary_button?.url,
        searchRaw.fallback_button?.url,
      ),
      tip_text: pickText(searchRaw.tip_text, searchRaw.tip, searchRaw.hint, searchRaw.note),
      primaryButton: {
        text: pickText(
          searchRaw.primary_button_text,
          searchRaw.primaryButton?.text,
