export const HOME = {
  ...
  heroExplore: "hero-explore-btn", heroBrowse: "hero-browse-btn", heroStats: "hero-stats-row",
  manifestoSection: "manifesto-section",
  archiveSection: "archive-overview-section",
  archiveCard: (key) => `archive-card-${key}`,
  featuredCoinsSection: "featured-coins-section",
  featuredCoinCard: (slug) => `featured-coin-${slug}`,
  featuredCoinsBrowse: "featured-coins-browse",
  ...
  learningSection: "collector-learning-section",
  learningLink: (key) => `collector-learning-${key}`,
  searchCtaSection: "search-cta-section",
  searchCtaOpen: "search-cta-open",
  searchCtaBrowse: "search-cta-browse",
  trustSection: "trust-section",
  trustPillar: (i) => `trust-pillar-${i}`,
